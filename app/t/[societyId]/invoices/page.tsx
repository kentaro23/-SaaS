...
import { generateAnnualInvoicesAction, generateReceiptAction, updateInvoiceAction } from "@/lib/actions";
...
export default async function InvoicesPage({
  ...
  const invoices = await repo.listInvoices({ fiscalYear, status });

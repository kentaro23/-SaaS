...
export const societySchema = z.object({
  ...
  admissionFee: z.coerce.number().int().nonnegative().optional().nullable(),
  annualFee: z.coerce.number().int().nonnegative().optional().nullable(),
  bankName: z.string().optional().nullable(),
  bankBranch: z.string().optional().nullable(),
  bankAccountType: z.string().optional().nullable(),
  bankAccountNumber: z.string().optional().nullable(),
  bankAccountHolder: z.string().optional().nullable(),
  bankNote: z.string().optional().nullable(),
...
export const memberSchema = z.object({
  ...
  kanaFamily: z.string().min(1),
  kanaGiven: z.string().min(1),
